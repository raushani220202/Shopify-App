...
const ProductDisplay = (props) => {
  ...
  <  div className="productdisplay-right-price-new">
           ...
           <div className="productdisplay-right-description">
            Stylish, comfortable, and crafted from high-quality materials, this product is perfect for everyday wear or special occasions. Designed to offer a great fit and modern appeal, it’s a must-have addition to your wardrobe.
            </div>
